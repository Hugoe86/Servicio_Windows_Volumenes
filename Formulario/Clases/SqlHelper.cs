...
// classes.
//
// The DAAB for MS .NET Provider for Sql has been tested in the context of this Nile implementation,
// but has not undergone the generic functional testing that the SQL version has gone through.
// You can use it in other .NET applications using Sql databases.  For complete docs explaining how to use
...
namespace SharpContent.ApplicationBlocks.Data
{
    ...
    public sealed class SqlHelper
    {
        ...
        /// </remarks>
        /// <param name="connectionString">a valid connection string for an OSqlConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or PL/SQL command</param>  
        /// <param name="commandParameters">an array of SqlParameters used to execute the command</param>
        /// <returns>an SqlDataReader containing the resultset generated by the command</returns>
